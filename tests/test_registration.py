...
class TestRegistration:
    ...
    def test_successful_registration(self, driver, wait, new_user_credentials):
        ...
        wait.until(expected_conditions.visibility_of_element_located(RegisterPageLocators.NAME_FIELD)).send_keys(new_user_credentials["name"])
        ...
        # После регистрации ждем появления формы логина и вводим данные
        wait.until(expected_conditions.visibility_of_element_located(LoginPageLocators.LOGIN_TITLE))
    ...
    def test_registration_with_invalid_password(self, driver, wait, new_user_credentials):
